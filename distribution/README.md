...
2. One sentence naming the guide and its audience.
3. "[Number] things moved on Microsoft Learn, and the guide moved with them:"
4. One bullet per material change: bold the product and the capability or
   outcome, explain the practical change in plain English, give GA, Preview
...
7. End with the full visible link to "What you can deploy today":
